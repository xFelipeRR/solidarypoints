<?php 
    ...
    if($_GET["tipo_msg"] == 'F') {
        $titulo = "Seu feedback já foi registrado e será analisado por nossos administradores";
        $subtitulo = "Obrigado pela ajuda!";
        $styleLineF = 'style="border-bottom: 1px solid #F53838; "';
    }
    else {
        $titulo = "Seu pedido de ajuda já foi registrado e será analisado por nossos administradores";
        $subtitulo = "Obrigado pela colaboração!";
        $styleLineH = 'style="border-bottom: 1px solid #F53838; "';
    }
?>
<!DOCTYPE html>
<html lang="en">
...
p {
    ...
    <div class="all-container">
          ...
          <div class="navbar">
            ...
            <div class="logo"><img src="../images/logo.svg"></div>
              <div class="nav-links">
                  ...
                  <li><a <?php echo $styleLineF; ?> href="feedback.php">Feedback</a></li>

                  <li><a <?php echo $styleLineH; ?> href="help.php">Ajuda</a></li>
        ...
        <div class="section">
            <div class="info">
                <p><?php echo $titulo; ?></p>
				<img width="120px" src="../images/feedback-ok.png">
                <br>
