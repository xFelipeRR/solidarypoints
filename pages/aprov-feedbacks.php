      ...
      <div class="beneficiado-intern">
        ...
        <div class="slider-forms">
          <form action="../script.php" method="POST">
            <input hidden name="visao" value="aprovacao_feedback">
            <input hidden name="tp_escolha" value="cancel">
            <input hidden name="id_feedback" value="'.$row["ID"].'">
            <button class="form-btn btn-cancela">Cancelar</button>
          </form>
          <form action="../script.php" method="POST">
            <input hidden name="visao" value="aprovacao_feedback">
            <input hidden name="tp_escolha" value="aprov">
            <input hidden name="id_feedback" value="'.$row["ID"].'">
            <button class="form-btn btn-aprova">Aprovar</button>
          </form>
        </div> 
...
<head>
    ...
    <title>Aprovação de Feedbacks | SolidaryPoints</title>
          ...
          <div style="background: white!important;" class="start-wrapper">
            <div class="align-div">
              <div class="start-description-container">
                <h2 class="title start">Aprovação de Feedbacks</h2>
                <p style="margin-top: -20px" class="description start">
                  Analise os feedbacks e aprove ou cancele de acordo com a leitura
                </p>
              </div>
