...
$query = "
  SELECT P.*,USR.NOME FROM PONTOS P
...
while($row = $result->fetch_array()){
    ...
    <a class="beneficiado-card">
      <div class="beneficiado-intern">
        <div class="img-name-slider">
          <img src="../images/green-adress-point.png">
        ...
        <div class="slider-forms">
          <form action="../script.php" method="POST">
            <input hidden name="visao" value="pontos_sts">
            <input hidden name="tp_escolha" value="C">
            <input hidden name="id_ponto" value="'.$row["ID"].'">
            <button class="form-btn btn-cancela">Cancelar</button>
          </form>
          <form action="../script.php" method="POST">
            <input hidden name="visao" value="pontos_sts">
            <input hidden name="tp_escolha" value="F">
            <input hidden name="id_ponto" value="'.$row["ID"].'">
  ...
  if($row["TP_PONTO"] == 'CO') {
    ...
    <a class="beneficiado-card">
      <div class="beneficiado-intern">
        <div class="img-name-slider">
          <img src="../images/blue-adress-point.png">
          <h4 class="slider-title">'.$row["DESCRICAO"].'</h4>
        </div>
  ...
  if($row["TP_PONTO"] == 'DI') {
    ...
    <a class="beneficiado-card">
      <div class="beneficiado-intern">
        <div class="img-name-slider">
          <img src="../images/yellow-adress-point.png">
          <h4 class="slider-title">'.$row["DESCRICAO"].'</h4>
        </div>
...
<head>
    ...
    <title>Monitoração de Pontos | SolidaryPoints</title>
          ...
          <div style="background: white!important;" class="start-wrapper">
            <div class="align-div">
              <div class="start-description-container">
                <h2 class="title start">Monitoração de Pontos</h2>
                <p style="margin-top: -20px" class="description start">
                  Aqui você pode conferir os pontos que estão em aberto, e finalizar ou cancelar o mesmo de acordo com a sua atual disponibilidade.
                </p>
              </div>
